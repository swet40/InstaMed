    ...
    return (
        ...
        <div className="w-full lg:w-8/12 lg:mx-8">
            ...
            <h2 className="text-3xl font-semibold mb-2">
                <span className="block text-lg text-gray-500">Read Professional Articles</span>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                <div className="mb-2">
                    <a href="https://amentotech.com/projects/doctreat/category/diagnostic-radiology/" className="text-sm text-blue-600">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                <div className="mb-2">
                    <a href="https://amentotech.com/projects/doctreat/category/dermatology/" className="text-sm text-blue-600">
                    Dermatology
                    </a>
                </div>
                <h3 className="text-lg font-semibold mb-2">
